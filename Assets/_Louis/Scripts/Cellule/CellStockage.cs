        ...
        if (currentProximityLevel > 0)
        {
            switch (currentProximityLevel)
            {
                case 0:
                    ...
                    currentBlobStockage = stockageCapacity[0];
                    break;
                case 1:
                    currentProximityTier = 1;
                    currentBlobStockage = stockageCapacity[1];
                    break;
                case 2:
                    currentProximityTier = 2;
                    currentBlobStockage = stockageCapacity[2];
                    break;
                case 3:
                    currentProximityTier = 3;
                    currentBlobStockage = stockageCapacity[3];
                    break;
