...
Shader "S_Link"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float smoothstepResult43 = smoothstep( 0.29 , 1.01 , uv_TexCoord15.x);
			float smoothstepResult46 = smoothstep( 0.29 , 1.01 , ( 1.0 - uv_TexCoord15.x ));
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_81_0 = ( ( tex2D( _T_OpaLinkCercle, uv_TexCoord94 ).r * ( temp_output_50_0 * 2.0 ) ) + tex2D( _T_OpaLink, uv_T_OpaLink ).b );
			float temp_output_85_0 = step( 0.68 , temp_output_81_0 );
			float temp_output_88_0 = step( 0.52 , temp_output_81_0 );
...
/*ASEBEGIN
Version=15900
-1920;0;1920;1019;1760.759;143.655;2.776899;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-1011.281,1323.613;Float;False;Property;_TranstionRatio;TranstionRatio;8;0;Create;True;0;0;False;0;0.3919734;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-538.7938,622.2163;Float;False;Constant;_Float0;Float 0;4;0;Create;True;0;0;False;0;1.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;67;-532.2296,551.5024;Float;False;Constant;_Float1;Float 1;4;0;Create;True;0;0;False;0;0.29;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;114;421.8033,732.7221;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;83;1785.204,758.5747;Float;False;Property;_InnerPlayer;InnerPlayer;5;0;Create;True;0;0;False;0;1,0.7926845,0.4292453,0;1,0.7926845,0.4292453,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;84;1560.204,1526.317;Float;False;Property;_OuterColor;OuterColor;6;0;Create;True;0;0;False;0;0.5660378,0.5660378,0.5660378,0;0.5660378,0.5660378,0.5660378,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-4.679114,41.30311;Float;True;Property;_DeformationValue;DeformationValue;1;0;Create;True;0;0;False;0;1;8;0.5;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B6889ED696EFC3391B8F3008F95BD5851224D8F8